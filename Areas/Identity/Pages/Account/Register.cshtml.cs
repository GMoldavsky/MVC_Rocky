...
namespace MVC_Rocky.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //Update code to allow only Admin users register new Admin
                    //await _userManager.AddToRoleAsync(user, WC.AdminRole);//It will create default Admin User when sombody login tyo App
                    ...
                    else
                    {
                        if (!User.IsInRole(WC.AdminRole))
                        {
                            ...
                            //return Page();//Stay on registration page
